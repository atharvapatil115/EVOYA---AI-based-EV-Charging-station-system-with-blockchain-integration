...
const SignInPage = () => {
  ...
  const handleSignUpClick = () => {
    navigate('/user-type', { state: { userType: null } });
  };
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-8 space-y-8">
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              type="button"
              className="w-full flex justify-center items-center gap-3 bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
            >
              <svg
                className="h-5 w-5"
                xmlns="http://www.w3.org/2000/svg"
